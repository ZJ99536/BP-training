...
model = Sequential()
model.add(Dense(32, input_shape=(15,), activation='softplus'))
...
history = model.fit(X, y, epochs=10, batch_size=3, validation_split=0.2)
# evaluate the keras model
_, accuracy = model.evaluate(X, y)
print('Accuracy: %.2f' % (accuracy*100))

model.save('/home/zhoujin/learning/model/quad2_m4.h5')
